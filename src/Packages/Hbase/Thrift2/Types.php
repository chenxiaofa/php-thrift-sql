...
class TResult {
  ...
  public $row = null;
  /**
   * @var \Hbase\Thrift2\TColumnValue[]
   */
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        2 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => 'Hbase\Thrift2\TColumnValue',
            ),
          ),
        );
    }
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem5 = null;
              $elem5 = new \Hbase\Thrift2\TColumnValue();
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem35 = null;
              $elem35 = new \Hbase\Thrift2\TColumnValue();
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem83 = null;
              $elem83 = new \Hbase\Thrift2\TColumnValue();
