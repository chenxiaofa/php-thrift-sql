...
interface THBaseServiceIf {
   ...
   * 
   * @param \Hbase\Thrift2\TGet $tget the TGet to check for
   * 
   * @return bool
   * @throws \Hbase\Thrift2\TIOError
   */
  public function exists($table, \Hbase\Thrift2\TGet $tget);
  /**
   ...
   * @param string $table the table to check on
   * 
   * @param \Hbase\Thrift2\TGet[] $tgets a list of TGets to check for
   * 
   * @return bool[]
   * @throws \Hbase\Thrift2\TIOError
   */
   ...
   * 
   * @param \Hbase\Thrift2\TGet $tget the TGet to fetch
   * 
   * @return \Hbase\Thrift2\TResult if no Result is found, row and columnValues will not be set.
   * 
   * @throws \Hbase\Thrift2\TIOError
   */
  public function get($table, \Hbase\Thrift2\TGet $tget);
  /**
   ...
   * @param string $table the table to get from
   * 
   * @param \Hbase\Thrift2\TGet[] $tgets a list of TGets to fetch, the Result list
   * will have the Results at corresponding positions
   * or null if there was an error
   * 
   * @return \Hbase\Thrift2\TResult[]
   * @throws \Hbase\Thrift2\TIOError
   */
   ...
   * 
   * @param \Hbase\Thrift2\TPut $tput the TPut to put
   * 
   * @throws \Hbase\Thrift2\TIOError
   */
  public function put($table, \Hbase\Thrift2\TPut $tput);
  /**
   ...
   * column in question
   * 
   * @param \Hbase\Thrift2\TPut $tput the TPut to put if the check succeeds
   * 
   * @return bool
   * @throws \Hbase\Thrift2\TIOError
   */
  public function checkAndPut($table, $row, $family, $qualifier, $value, \Hbase\Thrift2\TPut $tput);
  /**
   * Commit a List of Puts to the table.
   * 
   * @param string $table the table to put data in
   * 
   * @param \Hbase\Thrift2\TPut[] $tputs a list of TPuts to commit
   * 
   * @throws \Hbase\Thrift2\TIOError
   */
   ...
   * 
   * @param \Hbase\Thrift2\TDelete $tdelete the TDelete to delete
   * 
   * @throws \Hbase\Thrift2\TIOError
   */
  public function deleteSingle($table, \Hbase\Thrift2\TDelete $tdelete);
  /**
   ...
   * @param string $table the table to delete from
   * 
   * @param \Hbase\Thrift2\TDelete[] $tdeletes list of TDeletes to delete
   * 
   * @return \Hbase\Thrift2\TDelete[]
   * @throws \Hbase\Thrift2\TIOError
   */
   ...
   * column in question
   * 
   * @param \Hbase\Thrift2\TDelete $tdelete the TDelete to execute if the check succeeds
   * 
   * @return bool
   * @throws \Hbase\Thrift2\TIOError
   */
  public function checkAndDelete($table, $row, $family, $qualifier, $value, \Hbase\Thrift2\TDelete $tdelete);
  /**
   * @param string $table the table to increment the value on
   * 
   * @param \Hbase\Thrift2\TIncrement $tincrement the TIncrement to increment
   * 
   * @return \Hbase\Thrift2\TResult if no Result is found, row and columnValues will not be set.
   * 
   * @throws \Hbase\Thrift2\TIOError
   */
  public function increment($table, \Hbase\Thrift2\TIncrement $tincrement);
  /**
   * @param string $table the table to append the value on
   * 
   * @param \Hbase\Thrift2\TAppend $tappend the TAppend to append
   * 
   * @return \Hbase\Thrift2\TResult if no Result is found, row and columnValues will not be set.
   * 
   * @throws \Hbase\Thrift2\TIOError
   */
  public function append($table, \Hbase\Thrift2\TAppend $tappend);
  /**
   ...
   * 
   * @param \Hbase\Thrift2\TScan $tscan the scan object to get a Scanner for
   * 
   * @return int
   * @throws \Hbase\Thrift2\TIOError
   */
  public function openScanner($table, \Hbase\Thrift2\TScan $tscan);
  /**
   ...
   * @return \Hbase\Thrift2\TResult[]
   * @throws \Hbase\Thrift2\TIOError
   * @throws \Hbase\Thrift2\TIllegalArgument if the scannerId is invalid
   * 
   */
   ...
   * 
   * @param \Hbase\Thrift2\TRowMutations $trowMutations mutations to apply
   * 
   * @throws \Hbase\Thrift2\TIOError
   */
  public function mutateRow($table, \Hbase\Thrift2\TRowMutations $trowMutations);
  /**
   ...
   * @throws \Hbase\Thrift2\TIOError
   */
  public function getScannerResults($table, \Hbase\Thrift2\TScan $tscan, $numRows);
  /**
   ...
   * @param string $row
   * @param bool $reload
   * @return \Hbase\Thrift2\THRegionLocation
   * @throws \Hbase\Thrift2\TIOError
   */
   ...
   * 
   * @param \Hbase\Thrift2\TRowMutations $rowMutations row mutations to execute if the value matches
   * 
   * @return bool
   * @throws \Hbase\Thrift2\TIOError
   */
  public function checkAndMutate($table, $row, $family, $qualifier, $compareOp, $value, \Hbase\Thrift2\TRowMutations $rowMutations);
}


class THBaseServiceClient implements \Hbase\Thrift2\THBaseServiceIf {
  ...
  public function send_exists($table, \Hbase\Thrift2\TGet $tget)
  {
    $args = new \Hbase\Thrift2\THBaseService_exists_args();
    $args->table = $table;
    $args->tget = $tget;
  ...
  public function recv_exists()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Hbase\Thrift2\THBaseService_exists_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Hbase\Thrift2\THBaseService_exists_result();
  ...
  {
    $args = new \Hbase\Thrift2\THBaseService_existsAll_args();
    $args->table = $table;
    $args->tgets = $tgets;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Hbase\Thrift2\THBaseService_existsAll_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Hbase\Thrift2\THBaseService_existsAll_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_get($table, \Hbase\Thrift2\TGet $tget)
  {
    $args = new \Hbase\Thrift2\THBaseService_get_args();
    $args->table = $table;
    $args->tget = $tget;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Hbase\Thrift2\THBaseService_get_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Hbase\Thrift2\THBaseService_get_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Hbase\Thrift2\THBaseService_getMultiple_args();
    $args->table = $table;
    $args->tgets = $tgets;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Hbase\Thrift2\THBaseService_getMultiple_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Hbase\Thrift2\THBaseService_getMultiple_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_put($table, \Hbase\Thrift2\TPut $tput)
  {
    $args = new \Hbase\Thrift2\THBaseService_put_args();
    $args->table = $table;
    $args->tput = $tput;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Hbase\Thrift2\THBaseService_put_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Hbase\Thrift2\THBaseService_put_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->io !== null) {
  ...
  public function send_checkAndPut($table, $row, $family, $qualifier, $value, \Hbase\Thrift2\TPut $tput)
  {
    $args = new \Hbase\Thrift2\THBaseService_checkAndPut_args();
    $args->table = $table;
    $args->row = $row;
    $args->family = $family;
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Hbase\Thrift2\THBaseService_checkAndPut_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Hbase\Thrift2\THBaseService_checkAndPut_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Hbase\Thrift2\THBaseService_putMultiple_args();
    $args->table = $table;
    $args->tputs = $tputs;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Hbase\Thrift2\THBaseService_putMultiple_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Hbase\Thrift2\THBaseService_putMultiple_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->io !== null) {
  ...
  public function send_deleteSingle($table, \Hbase\Thrift2\TDelete $tdelete)
  {
    $args = new \Hbase\Thrift2\THBaseService_deleteSingle_args();
    $args->table = $table;
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Hbase\Thrift2\THBaseService_deleteSingle_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Hbase\Thrift2\THBaseService_deleteSingle_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->io !== null) {
  ...
  {
    $args = new \Hbase\Thrift2\THBaseService_deleteMultiple_args();
    $args->table = $table;
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Hbase\Thrift2\THBaseService_deleteMultiple_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Hbase\Thrift2\THBaseService_deleteMultiple_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_checkAndDelete($table, $row, $family, $qualifier, $value, \Hbase\Thrift2\TDelete $tdelete)
  {
    $args = new \Hbase\Thrift2\THBaseService_checkAndDelete_args();
    $args->table = $table;
    $args->row = $row;
    $args->family = $family;
    $args->qualifier = $qualifier;
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Hbase\Thrift2\THBaseService_checkAndDelete_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Hbase\Thrift2\THBaseService_checkAndDelete_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_increment($table, \Hbase\Thrift2\TIncrement $tincrement)
  {
    $args = new \Hbase\Thrift2\THBaseService_increment_args();
    $args->table = $table;
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Hbase\Thrift2\THBaseService_increment_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Hbase\Thrift2\THBaseService_increment_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_append($table, \Hbase\Thrift2\TAppend $tappend)
  {
    $args = new \Hbase\Thrift2\THBaseService_append_args();
    $args->table = $table;
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Hbase\Thrift2\THBaseService_append_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Hbase\Thrift2\THBaseService_append_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_openScanner($table, \Hbase\Thrift2\TScan $tscan)
  {
    $args = new \Hbase\Thrift2\THBaseService_openScanner_args();
    $args->table = $table;
    $args->tscan = $tscan;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Hbase\Thrift2\THBaseService_openScanner_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Hbase\Thrift2\THBaseService_openScanner_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Hbase\Thrift2\THBaseService_getScannerRows_args();
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Hbase\Thrift2\THBaseService_getScannerRows_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Hbase\Thrift2\THBaseService_getScannerRows_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Hbase\Thrift2\THBaseService_closeScanner_args();
    $args->scannerId = $scannerId;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Hbase\Thrift2\THBaseService_closeScanner_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Hbase\Thrift2\THBaseService_closeScanner_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->io !== null) {
  ...
  public function send_mutateRow($table, \Hbase\Thrift2\TRowMutations $trowMutations)
  {
    $args = new \Hbase\Thrift2\THBaseService_mutateRow_args();
    $args->table = $table;
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Hbase\Thrift2\THBaseService_mutateRow_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Hbase\Thrift2\THBaseService_mutateRow_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->io !== null) {
  ...
  public function send_getScannerResults($table, \Hbase\Thrift2\TScan $tscan, $numRows)
  {
    $args = new \Hbase\Thrift2\THBaseService_getScannerResults_args();
    $args->table = $table;
    $args->tscan = $tscan;
    $args->numRows = $numRows;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Hbase\Thrift2\THBaseService_getScannerResults_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Hbase\Thrift2\THBaseService_getScannerResults_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Hbase\Thrift2\THBaseService_getRegionLocation_args();
    $args->table = $table;
    $args->row = $row;
    $args->reload = $reload;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Hbase\Thrift2\THBaseService_getRegionLocation_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Hbase\Thrift2\THBaseService_getRegionLocation_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Hbase\Thrift2\THBaseService_getAllRegionLocations_args();
    $args->table = $table;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Hbase\Thrift2\THBaseService_getAllRegionLocations_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Hbase\Thrift2\THBaseService_getAllRegionLocations_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  public function send_checkAndMutate($table, $row, $family, $qualifier, $compareOp, $value, \Hbase\Thrift2\TRowMutations $rowMutations)
  {
    $args = new \Hbase\Thrift2\THBaseService_checkAndMutate_args();
    $args->table = $table;
    $args->row = $row;
    $args->family = $family;
    $args->qualifier = $qualifier;
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Hbase\Thrift2\THBaseService_checkAndMutate_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Hbase\Thrift2\THBaseService_checkAndMutate_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::STRUCT) {
            $this->tget = new \Hbase\Thrift2\TGet();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->io = new \Hbase\Thrift2\TIOError();
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem131 = null;
              $elem131 = new \Hbase\Thrift2\TGet();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \Hbase\Thrift2\TResult();
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem145 = null;
              $elem145 = new \Hbase\Thrift2\TGet();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem152 = null;
              $elem152 = new \Hbase\Thrift2\TResult();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::STRUCT) {
            $this->tput = new \Hbase\Thrift2\TPut();
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem159 = null;
              $elem159 = new \Hbase\Thrift2\TPut();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::STRUCT) {
            $this->tdelete = new \Hbase\Thrift2\TDelete();
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem166 = null;
              $elem166 = new \Hbase\Thrift2\TDelete();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem173 = null;
              $elem173 = new \Hbase\Thrift2\TDelete();
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        2 => array(
          'var' => 'tincrement',
          'type' => TType::STRUCT,
          'class' => '\Hbase\Thrift2\TIncrement',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::STRUCT) {
            $this->tincrement = new \Hbase\Thrift2\TIncrement();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::STRUCT) {
            $this->tappend = new \Hbase\Thrift2\TAppend();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::STRUCT) {
            $this->tscan = new \Hbase\Thrift2\TScan();
...
class THBaseService_getScannerRows_result {
   ...
   * 
   * @var \Hbase\Thrift2\TIllegalArgument
   */
  public $ia = null;
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        2 => array(
          'var' => 'ia',
          'type' => TType::STRUCT,
          'class' => '\Hbase\Thrift2\TIllegalArgument',
          ),
        );
    }
    if (is_array($vals)) {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem180 = null;
              $elem180 = new \Hbase\Thrift2\TResult();
        ...
        case 2:
          if ($ftype == TType::STRUCT) {
            $this->ia = new \Hbase\Thrift2\TIllegalArgument();
...
class THBaseService_mutateRow_args {
   ...
   * mutations to apply
   * 
   * @var \Hbase\Thrift2\TRowMutations
   */
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        ...
        2 => array(
          'var' => 'trowMutations',
          'type' => TType::STRUCT,
          'class' => '\Hbase\Thrift2\TRowMutations',
          ),
        );
    }
    if (is_array($vals)) {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::STRUCT) {
            $this->trowMutations = new \Hbase\Thrift2\TRowMutations();
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem187 = null;
              $elem187 = new \Hbase\Thrift2\TResult();
...
class THBaseService_getRegionLocation_result {
  ...
  /**
   * @var \Hbase\Thrift2\THRegionLocation
   */
  public $success = null;
  /**
   * @var \Hbase\Thrift2\TIOError
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          'var' => 'success',
          'type' => TType::STRUCT,
          'class' => '\Hbase\Thrift2\THRegionLocation',
          ),
        1 => array(
          'var' => 'io',
          'type' => TType::STRUCT,
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \Hbase\Thrift2\THRegionLocation();
            $xfer += $this->success->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem194 = null;
              $elem194 = new \Hbase\Thrift2\THRegionLocation();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 7:
          if ($ftype == TType::STRUCT) {
            $this->rowMutations = new \Hbase\Thrift2\TRowMutations();
