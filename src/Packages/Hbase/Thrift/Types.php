      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::LST) {
            ...
            {
              $elem5 = null;
              $elem5 = new \Hbase\Thrift\Mutation();
      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::STRUCT) {
            $this->cell = new \Hbase\Thrift\TCell();
      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::LST) {
            ...
            {
              $elem19 = null;
              $elem19 = new \Hbase\Thrift\TColumn();
...
class TScan {
  ...
  public function write($output) {
    ...
    if ($this->cacheBlocks !== null) {
      $xfer += $output->writeFieldBegin('cacheBlocks', TType::BOOL, 10);
